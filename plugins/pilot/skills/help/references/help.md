...
- **Implement a slice:** Approve a defined slice and ask Pilot to build it. Pilot implements exactly that slice, reports whether user acceptance or evidence establishes the result, then stops.
...
- **Troubleshoot:** Give Pilot a concrete failure to diagnose. A fix request starts diagnosis, but Pilot waits for approval of the discovered correction before applying it.
